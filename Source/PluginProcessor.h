...
public:
    ...
    //==============================================================================
    void updateLowFilter(float gain, int rawFreqKnob);
    void updateLowMidFilter(float gain, int rawFreqKnob);
    void updateHighMidFilter(float gain, int rawFreqKnob);
    void updateHighFilter(float gain, int rawFreqKnob);

    juce::AudioProcessorValueTreeState treeState;
    
    float lastSampleRate;
    
    std::vector<float> rawLowFrequencySliderValues = {30.0f, 40.0f, 50.0f, 100.0f, 200.0f, 300.0f, 400.0f};
    std::vector<float> rawLowMidFrequencySliderValues = {75.0f, 150.0f, 180.0f, 240.0f, 500.0f, 700.0f, 1000.0f};
    std::vector<float> rawHighMidFrequencySliderValues = {800.0f, 1500.0f, 3000.0f, 5000.0f, 8000.0f, 10000.0f, 12500.0f};
